...
tasks/Task.cpp, and will be put in the maps namespace.
     ...
     */
    class PointCloudAggregator : public PointCloudAggregatorBase
    {
	friend class PointCloudAggregatorBase;
    protected:

        virtual void bodyPoseCallback(const base::Time &ts, const ::base::samples::RigidBodyState &bodyPose_sample);
    ...
    public:
         ...
         * 
         */
        PointCloudAggregator(std::string const& name, RTT::ExecutionEngine* engine);

        /** Default deconstructor of PointCloudAggregator
         */
